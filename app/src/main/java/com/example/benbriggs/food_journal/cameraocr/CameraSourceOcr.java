 ...
 * {@link CameraSourceOcr.Builder#setRequestedFps(float)} to specify a frame rate that works well with
...
public class CameraSourceOcr {
    ...
    public static class Builder {
        ...
        private CameraSourceOcr mCameraSource = new CameraSourceOcr();
    ...
    public CameraSourceOcr start() throws IOException {
        synchronized (mCameraLock) {
            if (mCamera != null) {
                return this;
            }
     ...
     */
    @RequiresPermission(Manifest.permission.CAMERA)
    public CameraSourceOcr start(SurfaceHolder surfaceHolder) throws IOException {
        synchronized (mCameraLock) {
            if (mCamera != null) {
                return this;
            }
